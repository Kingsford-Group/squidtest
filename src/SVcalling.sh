...
for (( i=3; i<10; i++)); do
	...
	python3 bin/VerifySVpred.py 1 $ProjectDir/WholeGenome/TSV_truepos.txt $ProjectDir/TSVcall/SQUID_STAR/squid_w${i}_sv.txt $ProjectDir/TSVcall/SQUID_STAR/squid_w${i}_sv_hit.txt
done
...
for (( i=3; i<10; i++)); do
	...
	python3 bin/VerifySVpred.py 1 $ProjectDir/WholeGenome/TSV_truepos.txt $ProjectDir/TSVcall/SQUID_BWA/squid_w${i}_sv.txt $ProjectDir/TSVcall/SQUID_BWA/squid_w${i}_sv_hit.txt
done
...
python3 bin/VerifySVpred.py 2 WholeGenome/TSV_truepos.txt TSVcall/DELLY_STAR/delly_SV.vcf TSVcall/DELLY_STAR/hit.txt
# Delly_BWA
...
python3 bin/VerifySVpred.py 2 $ProjectDir/WholeGenome/TSV_truepos.txt $ProjectDir/TSVcall/DELLY_BWA/delly_SV.vcf $ProjectDir/TSVcall/DELLY_BWA/hit.txt
...
for (( i=3; i<10; i++)); do
	...
	python3 bin/VerifySVpred.py 2 $ProjectDir/WholeGenome/TSV_truepos.txt $ProjectDir/TSVcall/LUMPY/lumpy_thresh$i.vcf $ProjectDir/TSVcall/LUMPY/hit_thresh$i.txt
done
...
python3 bin/VerifySVpred.py 5 $ProjectDir/WholeGenome/TSV_truepos.txt $ProjectDir/TSVcall/TransABySS/nucm_res.bedpe $ProjectDir/TSVcall/TransABySS/nucm_res_hit.bedpe
...
python3 bin/VerifySVpred.py 5 $ProjectDir/WholeGenome/TSV_truepos.txt $ProjectDir/TSVcall/TransABySS/gmap_res.bedpe $ProjectDir/TSVcall/TransABySS/gmap_res_hit.bedpe
...
python3 bin/VerifySVpred.py 5 $ProjectDir/WholeGenome/TSV_truepos.txt $ProjectDir/TSVcall/Trinity/nucm_res.bedpe $ProjectDir/TSVcall/Trinity/nucm_res_hit.bedpe
...
python3 bin/VerifySVpred.py 5 $ProjectDir/WholeGenome/TSV_truepos.txt $ProjectDir/TSVcall/Trinity/gmap_res.bedpe $ProjectDir/TSVcall/Trinity/gmap_res_hit.bedpe