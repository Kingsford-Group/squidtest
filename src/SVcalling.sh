...
for (( i=3; i<10; i++)); do
	...
	python bin/VerifySVpred.py 1 $ProjectDir/WholeGenome/TSV_truepos.txt $ProjectDir/TSVcall/SQUID_STAR/squid_w${i}_sv.txt $ProjectDir/TSVcall/SQUID_STAR/squid_w${i}_sv_hit.txt
done
...
for (( i=3; i<10; i++)); do
	...
	python bin/VerifySVpred.py 1 $ProjectDir/WholeGenome/TSV_truepos.txt $ProjectDir/TSVcall/SQUID_BWA/squid_w${i}_sv.txt $ProjectDir/TSVcall/SQUID_BWA/squid_w${i}_sv_hit.txt
done
...
python bin/VerifySVpred.py 2 $ProjectDir/WholeGenome/TSV_truepos.txt $ProjectDir/TSVcall/DELLY_STAR/delly_SV.vcf $ProjectDir/TSVcall/DELLY_STAR/hit.txt
Delly_BWA
...
python bin/VerifySVpred.py 2 $ProjectDir/WholeGenome/TSV_truepos.txt $ProjectDir/TSVcall/DELLY_BWA/delly_SV.vcf $ProjectDir/TSVcall/DELLY_BWA/hit.txt
...
for (( i=3; i<10; i++)); do
	...
	python bin/VerifySVpred.py 2 $ProjectDir/WholeGenome/TSV_truepos.txt $ProjectDir/TSVcall/LUMPY/lumpy_thresh$i.vcf $ProjectDir/TSVcall/LUMPY/hit_thresh$i.txt
done

# preparing for gmap
mkdir -p $ProjectDir/WholeGenome/Chromosomes/
if [[ $(find $ProjectDir/WholeGenome/Chromosomes/ -name *.fa) == "" ]]; then
	python bin/ReadGenome.py $ProjectDir/WholeGenome/genome_rearranged.fa $ProjectDir/WholeGenome/Chromosomes/
fi
...
# TransABySS + mummer3
transabyss -k 25 --pe $ProjectDir/Reads/RNA1.fq.gz $ProjectDir/Reads/RNA2.fq.gz --outdir $ProjectDir/TSVcall/TransABySS/k25 --name k25 --threads ${threads} --island 0
transabyss -k 32 --pe $ProjectDir/Reads/RNA1.fq.gz $ProjectDir/Reads/RNA2.fq.gz --outdir $ProjectDir/TSVcall/TransABySS/k32 --name k32 --threads ${threads} --island 0
...
python bin/VerifySVpred.py 5 $ProjectDir/WholeGenome/TSV_truepos.txt $ProjectDir/TSVcall/TransABySS/nucm_res.bedpe $ProjectDir/TSVcall/TransABySS/nucm_res_hit.bedpe
...
python bin/VerifySVpred.py 5 $ProjectDir/WholeGenome/TSV_truepos.txt $ProjectDir/TSVcall/TransABySS/gmap_res.bedpe $ProjectDir/TSVcall/TransABySS/gmap_res_hit.bedpe

# trinity + mummer3
Trinity --seqType fq --max_memory 50G --left $ProjectDir/Reads/RNA1.fq.gz --right $ProjectDir/Reads/RNA2.fq.gz --CPU ${threads} --output $ProjectDir/TSVcall/Trinity
...
python bin/VerifySVpred.py 5 $ProjectDir/WholeGenome/TSV_truepos.txt $ProjectDir/TSVcall/Trinity/nucm_res.bedpe $ProjectDir/TSVcall/Trinity/nucm_res_hit.bedpe
...
python bin/VerifySVpred.py 5 $ProjectDir/WholeGenome/TSV_truepos.txt $ProjectDir/TSVcall/Trinity/gmap_res.bedpe $ProjectDir/TSVcall/Trinity/gmap_res_hit.bedpe